...
extension TinyColorExtension on Color {
  ...
  Color brighten([int amount = 10]) => TinyColor.fromColor(this).brighten(amount).color;

  /// Darken the color a given amount, from 0 to 100. Providing 100 will always return black.
  Color darken([int amount = 10]) => TinyColor.fromColor(this).darken(amount).color;
  ...
  Color shade([int amount = 10]) => TinyColor.fromColor(this).shade(amount).color;
